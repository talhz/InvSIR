from .SIR_reg import SlicedInverseRegression
import numpy as np
...
class SIRd:
    def __init__(self, x, y, reduced_dim=2, H=10):
        ...
        ----------
        x: array(array(array))
            n_e by n_i by p array representing covariates
        y: array(array)
        ...
        self.H = H
        self.x = x # list(tensor)
        self.y = y # list(list(float))
        self.k = reduced_dim
